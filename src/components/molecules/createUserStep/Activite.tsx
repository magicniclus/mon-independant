  ...
  useEffect(() => {
    dispatch(
      setActiviteDetails({
        ...formValues,
        debutActivite:
          formValues.debutActivite?.format("YYYY-MM-DD") || undefined,
      })
    );
  }, [formValues]);
      ...
      <div className="flex justify-between flex-col">
        ...
        <div className="w-full mt-5 flex justify-between flex-col">
          ...
          <div className="w-full flex justify-between">
            <div
              className="flex mt-2 w-[30%] flex-col items-end p-3 py-5 border hover:border-slate-500 focus:border-slate-500 rounded-md relative cursor-pointer"
              onClick={() =>
                setFormValues({
                  ...formValues,
                  activiteNonSalarie: "non",
